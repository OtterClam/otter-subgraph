...
import { WMEMO_NAV_REPORTER } from '../utils/Constants'
import { IStrategy } from '../../generated/OtterClamERC20V2/IStrategy'
import { InvestmentInterface, loadOrCreateInvestment } from '.'

export class WMEMOInvestment implements InvestmentInterface {
  public investment!: Investment
  public readonly strategy: string = 'wMEMO'
  public readonly protocol: string = 'Wonderland'
  public readonly startBlock: BigInt = BigInt.fromI32(36690125)
  ...
  netAssetValue(): BigDecimal {
    if (this.active) {
      let tryNAV = IStrategy.bind(WMEMO_NAV_REPORTER).try_netAssetValue()
