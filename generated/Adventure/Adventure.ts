...
export class Adventure__latestPassOfResultValue0Struct extends ethereum.Tuple {
  get locId(): BigInt {
  ...
  get rewards(): Adventure__latestPassOfResultValue0RewardsStruct {
    return changetype<Adventure__latestPassOfResultValue0RewardsStruct>(
      this[8].toTuple()
    );
  }
...
export class Adventure__latestPassOfResultValue0RewardsStruct extends ethereum.Tuple {
  get exp(): BigInt {
    return this[0].toBigInt();
  }
...
export class Adventure__passResultValue0Struct extends ethereum.Tuple {
  get locId(): BigInt {
    return this[0].toBigInt();
  }
  ...
  get rewards(): Adventure__passResultValue0RewardsStruct {
    return changetype<Adventure__passResultValue0RewardsStruct>(
      this[8].toTuple()
    );
  }
...
export class Adventure__passResultValue0RewardsStruct extends ethereum.Tuple {
  get exp(): BigInt {
    return this[0].toBigInt();
  }
...
export class Adventure extends ethereum.SmartContract {
  static bind(address: Address): Adventure {
    return new Adventure("Adventure", address);
  }
  ...
  MAX_OTTOS_PER_WALLET(): BigInt {
    let result = super.call(
      "MAX_OTTOS_PER_WALLET",
      "MAX_OTTOS_PER_WALLET():(uint256)",
      []
    );
  ...
  try_MAX_OTTOS_PER_WALLET(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "MAX_OTTOS_PER_WALLET",
      "MAX_OTTOS_PER_WALLET():(uint256)",
      []
  ...
  latestPassOf(ottoId_: BigInt): Adventure__latestPassOfResultValue0Struct {
    let result = super.call(
      "latestPassOf",
    ...
    return changetype<Adventure__latestPassOfResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_latestPassOf(
    ottoId_: BigInt
  ): ethereum.CallResult<Adventure__latestPassOfResultValue0Struct> {
    let result = super.tryCall(
      "latestPassOf",
      "latestPassOf(uint256):((uint256,uint256,uint256,uint256,uint256,uint256,bool,bool,(uint32,uint32,uint32,uint256[],uint256[]),uint32,uint32))",
      [ethereum.Value.fromUnsignedBigInt(ottoId_)]
    ...
    return ethereum.CallResult.fromValue(
      changetype<Adventure__latestPassOfResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  ottoCount(param0: Address, param1: BigInt): BigInt {
    let result = super.call(
      "ottoCount",
      "ottoCount(address,uint256):(uint256)",
      [
        ethereum.Value.fromAddress(param0),
  ...
  try_ottoCount(param0: Address, param1: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "ottoCount",
      "ottoCount(address,uint256):(uint256)",
      [
  ...
  ottoOwnerOf(ottoId_: BigInt): Address {
    let result = super.call("ottoOwnerOf", "ottoOwnerOf(uint256):(address)", [
      ethereum.Value.fromUnsignedBigInt(ottoId_)
    ]);
  ...
  try_ottoOwnerOf(ottoId_: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "ottoOwnerOf",
      "ottoOwnerOf(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(ottoId_)]
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  pass(passId_: BigInt): Adventure__passResultValue0Struct {
    let result = super.call(
      "pass",
    ...
    return changetype<Adventure__passResultValue0Struct>(result[0].toTuple());
  }

  try_pass(
    passId_: BigInt
  ): ethereum.CallResult<Adventure__passResultValue0Struct> {
    let result = super.tryCall(
      "pass",
      "pass(uint256):((uint256,uint256,uint256,uint256,uint256,uint256,bool,bool,(uint32,uint32,uint32,uint256[],uint256[]),uint32,uint32))",
      [ethereum.Value.fromUnsignedBigInt(passId_)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Adventure__passResultValue0Struct>(value[0].toTuple())
    );
  }
