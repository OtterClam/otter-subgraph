...
import {
  QUICKSWAPV3_MAI_USDT_START_BLOCK,
  QUICKSWAPV3_MAI_USDT_STRATEGY,
  UNIV3_USDC_MAI_STRATEGY,
} from '../utils/Constants'
import { InvestmentInterface, loadOrCreateInvestment } from '.'
import { IStrategy } from '../../generated/QuickswapV3MaiUsdtStrategy/IStrategy'
...
export class QuickswapV3MaiUsdtInvestment implements InvestmentInterface {
  ...
  netAssetValue(): BigDecimal {
    if (this.active) {
      let tryNAV = IStrategy.bind(QUICKSWAPV3_MAI_USDT_STRATEGY).try_netAssetValue()
